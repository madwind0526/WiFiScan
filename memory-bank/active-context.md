...
- Wave 13에서 삭제한 Windows Wi-Fi 프로필의 자동 재등록을 suppression 목록으로 막고 버전 `1.1.2+4`를 빌드했다.
- Wave 12에서 같은 서브넷의 ping을 Wi-Fi 출발 주소에 고정해 Ethernet 우회와 장비 누락을 수정하고 버전 `1.1.1+3`을 빌드했다.
